...
header = test.data.header_exec_prod
...
# Test Casting Director MOVIES
    ...
    def test_400_post_new_movie_malformed(self):
        res = self.client().post('/movies',
                                 headers=header)
        data = json.loads(res.data)
    ...
    def test_400_post_new_movie_incomplete(self):
        res = self.client().post('/movies',
    ...
    def test_404_delete_movie_by_id_notfound(self):
