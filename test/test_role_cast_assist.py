...
header = test.data.header_cast_assist
...
# Test Executive Producer ACTORS
    ...
    def test_403_post_new_actors(self):
    ...
    def test_403_post_new_actors_malformed(self):
        res = self.client().post('/actors',
                                 headers=header)
        data = json.loads(res.data)
    ...
    def test_403_post_new_actors_incomplete(self):
        res = self.client().post('/actors',
    ...
    def test_403_patch_actors(self):
    ...
    def test_403_patch_actors_notfound(self):
    ...
    def test_403_patch_actors_malformed(self):
        res = self.client().patch('/actors/3/edit',
                                  headers=header)
        data = json.loads(res.data)
    ...
    def test_403_patch_actors_incomplete(self):
        res = self.client().patch('/actors/3/edit',
    ...
    def test_403_delete_actor_by_id(self):
    ...
    def test_403_delete_actor_by_id_notfound(self):
...
# Test Executive Producer MOVIES
    ...
    def test_403_patch_movies(self):
    ...
    def test_403_patch_movies_notfound(self):
    ...
    def test_403_patch_movies_malformed(self):
        res = self.client().patch('/movies/99/edit',
                                  headers=header)
        data = json.loads(res.data)
    ...
    def test_403_patch_movies_incomplete(self):
